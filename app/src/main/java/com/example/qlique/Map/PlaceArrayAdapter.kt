...
class PlaceArrayAdapter(context: Context, private val resource: Int, val mPlacesClient: PlacesClient) : ArrayAdapter<PlaceDataModel>(context, resource),
    Filterable {
    ...
    override fun getFilter(): Filter {
        return object : Filter() {
            ...
            override fun performFiltering(constraint: CharSequence?): FilterResults {
                ...
                val intConnection = checkInternetConnection()
                if (constraint != null) {
                    resultList.clear()

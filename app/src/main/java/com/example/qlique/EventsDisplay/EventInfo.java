...
public class EventInfo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        membersInfo.setOnClickListener(v -> {
            ...
            //passes the event obj to the new intent
        ...
        FirebaseDatabase.getInstance().getReference("/users/" + event.uid).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NotNull DataSnapshot dataSnapshot) {
                ...
                if (user == null) {
                    Toast.makeText(getApplicationContext(), "A problem has been detected, please try again later", Toast.LENGTH_LONG).show();
                    return;
                }
                if (user.url != null) {
                ...
                if (checkIfAuthorIsCUrUser(user.uid, curUser)) {
                    ...
                    // user can not send to himself a message
                } else {

...
// Attach a listener to read the data at our posts reference
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                ImageView targetAuthorImageView = viewHolder.itemView.findViewById(R.id.user_profile_image_search);
                ...
                TextView targetAuthor =viewHolder.itemView.findViewById(R.id.cardContent_author);
